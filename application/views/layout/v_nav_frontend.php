...
<nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="<?= base_url() ?>" class="navbar-brand">
        ...
        <span class="brand-text font-weight-light"><b>DinusPedia</b></span>
      </a>
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <div class="search-bar" style="display: flex; align-items: center;">
            <input type="text" id="search-input" placeholder="    Cari barang..." style="padding: 5px; border: 1px solid #ccc; border-radius: 20px; margin-left: 20px; margin-top: 2px; width: 400px;">
            <button id="search-button" style="background-color: #007bff; color: #fff; border: none; border-radius: 20px; margin-left: -40px; cursor: pointer;"><i class="fas fa-search"></i></button>
          </div>
          </li>
        </ul>
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
        ...
        <?php if ($this->session->userdata('email') == "") { ?>
          <a class="nav-link" href="<?= base_url('pelanggan/login') ?>">
            ...
            <img src="<?= base_url() ?>template/dist/img/avatar5.png" alt="User" class="brand-image img-circle elevation-3" 
            style="opacity: .8">
          </a>
        <?php } else{ ?>
          <a class="nav-link" data-toggle="dropdown" href="#">
            <span class="brand-text font-weight-light"><?= $this->session->userdata('nama_pelanggan') ?></span>
            <img src="<?= base_url('assets/foto/'.$this->session->userdata('foto') ) ?>" alt="User" class="brand-image img-circle elevation-3" 
            style="opacity: .8">
          </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <div class="dropdown-divider"></div>
            <a href="<?= base_url('pelanggan/profile') ?>" class="dropdown-item">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">DinusPedia</a></li>
